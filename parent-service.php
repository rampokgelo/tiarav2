     ...
     <ul class="collapsible" data-collapsible="accordion">
           ...
           <ul class="list-service">
             <li>
               <a href="#" class="btn-block">
                 <div class="media">
                   <div class="media-left bg-cover" style="background-image:url('images/sample-asset.jpg');">
                     <div class="media-thumb-spacing"></div>
                   </div>
       ...
       <li>
         <div class="collapsible-header">
           <span class="collapsible-caret"><i class="icon-chevron-next"></i></span>
           <h3 class="collapsible-title">Reliability Service 2</h3>
         </div>
         <div class="collapsible-body">
           <p>
       ...
       <li>
         <div class="collapsible-header">
           <span class="collapsible-caret"><i class="icon-chevron-next"></i></span>
           <h3 class="collapsible-title">Reliability Service 3</h3>
         </div>
         <div class="collapsible-body">
           <p>
             Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
